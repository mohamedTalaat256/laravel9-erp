    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{ route('admin.treasuries.create') }}" class="btn btn-sm btn-success" >اضافة جديد<i class="fas fa-plus-circle m-2"></i></a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <div class="col-md-4">
<input type="text" id="search_by_text" placeholder="بحث بالاسم" class="form-control"> <br>
        ...
        <a href="{{ route('admin.treasuries.details',$info->id) }}" class="btn btn-sm btn-icon btn-info"><i class="fas fa-info-circle"></i></a>   
