        ...
        <form action="{{ route('admin.treasuries.update',$data['id']) }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="last_isal_exhcange"
              ...
              value="{{ old('last_isal_exhcange',$data['last_isal_exhcange']) }}" placeholder="ادخل اسم الشركة"
          ...
          <div class="form-group">
            ...
            <input oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="last_isal_collect"
              ...
              value="{{ old('last_isal_collect',$data['last_isal_collect']) }}" placeholder="ادخل اسم الشركة"
              oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')" onchange="try{setCustomValidity('')}catch(e){}">
