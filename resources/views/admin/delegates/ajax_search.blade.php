        ...
        <tbody>
            @foreach ($data as $info)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.delegates.edit', $info->id) }}" class="btn btn-sm  btn-primary"><i
                                class="fas fas-edit"></i></a>
                        <button data-id="{{ $info->id }}" class="btn btn-sm show_more_details  btn-info"><i
