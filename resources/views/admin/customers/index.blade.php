...
@section('content')
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="{{ route('admin.customer.create') }}" class="btn btn-sm btn-success" >اضافة جديد <i class="fas fa-plus-circle m-2"></i></a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <div class="row">
      ...
      متزن
        ...
        <a href="{{ route('admin.customer.edit',$info->id) }}" class="btn btn-sm  btn-primary "><i class="fas fa-edit"></i></a>   
