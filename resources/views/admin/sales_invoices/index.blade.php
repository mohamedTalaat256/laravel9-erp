                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <button data-autoserial="{{ $info->auto_serial }}"  class="btn btn-sm load_invoice_update_modal btn-primary"><i class="fa fa-edit"></i> </button>   
                           <a href="{{ route("admin.SalesInvoices.delete",$info->id) }}" class="btn btn-sm are_you_shue  btn-danger"><i class="fa fa-trash-alt"></i></a>   
                           @endif
                           <button data-autoserial="{{ $info->auto_serial }}"  class="btn btn-sm load_invoice_details_modal btn-info"><i class="fa fa-eye"></i></button>   
                          <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white" target="_blank" href="{{ route('admin.SalesInvoices.printsaleswina4',[$info->id,'A4']) }}" class="btn btn-primary btn-xs"> 4 <i class="fa fa-print"></i></a>
                          <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white" target="_blank" href="{{ route('admin.SalesInvoices.printsaleswina4',[$info->id,'A6']) }}" class="btn btn-warning btn-xs"> 6 <i class="fa fa-print"></i></a>
